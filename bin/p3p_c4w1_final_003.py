...
class BankAccount:
    """accepts the name you want associated with your bank account in a string, and an integer that represents the amount of money in the account"""
    def __init__(self,getN,getA):
        self.name=getN
        self.amt=getA

...
for r in range(50):
    print("Current level of {} is {}, attack strength is {}, waiting.".format(p3.name,p3.level,p3.attack))
    p3.train()
    if p3.level>=10:
        print("Current level of {} is {}, attack strength now {}.".format(p3.name,p3.level,p3.attack))
        break
